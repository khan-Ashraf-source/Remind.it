            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" style="color: white" href="?page=login&type=view">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color: white" href="?page=register&type=view">Register</a>
                    </li>
                </ul>
            </div>
        </nav>
        <div class="container" style="width: 400px; margin-top: 50px; color: white">
            <h2>Register</h2>
            <form action="/WorkD/Controller/?page=RegistrationModel&type=model" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fname" required id="exampleInputPassword1">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Last Name</label>
                    <input type="text" class="form-control" name="lname" required id="exampleInputPassword1">
                </div>
                <div class="form-group">
